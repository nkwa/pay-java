...
import io.github.nkwa.pay_sdk.models.operations.GetAvailabilityRequestBuilder;
    ...
    public GetAvailabilityResponse checkDirect() throws Exception {
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                List<io.github.nkwa.pay_sdk.models.components.Availability> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<List<io.github.nkwa.pay_sdk.models.components.Availability>>() {});
